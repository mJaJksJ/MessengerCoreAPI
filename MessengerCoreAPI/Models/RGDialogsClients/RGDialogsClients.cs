namespace MessengerCoreAPI.Models.RGDialogsClients
{
    /// <summary>
    /// Хранилище информации о том, какие пользователи взаимодействуют в рамках одного диалога
    /// </summary>
    public class RGDialogsClients
    {
        ...
        /// <summary>
        /// Получить набор сущностей, с которыми можно производить операции
        /// </summary>
        /// <returns></returns>
